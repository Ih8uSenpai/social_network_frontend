...
export const CropBanner: React.FC<CropTestProps> = ({profile, token, fetchProfile, setShowWindow, setShowSettings}) => {
                ...
                <DialogContent>
                    ...
                    {!!completedCrop && (
                        <>
                            ...
                            <div>
                                <a
                                    href="src/components/profile/components/CropBanner#hidden"
                                    ref={hiddenAnchorRef}
                                    download
                                    style={{
                                        position: 'absolute',
